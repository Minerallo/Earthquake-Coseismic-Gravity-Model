function varargout=Ca2004(varargin)
Model=varargin{1};
dxgrid=varargin{2};
longT2=varargin{3};
latT2=varargin{4};
...
for R=1:numel(dip1a)
      for j=Model
    %disp([num2str(R),'/',num2str(numel(W)),' Geometry calculation for Ca2004'])
...
for R=1:numel(dip1a)
    disp([num2str(R),'/',num2str(numel(dip1a)),' Okubo calculation for Ca2004'])
...
% m_proj('Miller Cylindrical','long',[-180 180],'lat',[-90 90]);
% % fig points
