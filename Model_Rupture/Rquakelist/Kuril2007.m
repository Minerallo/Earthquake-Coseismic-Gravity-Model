function varargout=Kuril2007(varargin)
Model=varargin{1};
dxgrid=varargin{2};
longT2=varargin{3};
latT2=varargin{4};
...
for R=1:numel(dip1a)
      for j=Model
    %disp([num2str(R),'/',num2str(numel(W)),' Geometry calculation for Kuril2007'])
...
for R=1:numel(dip1a)
    disp([num2str(R),'/',num2str(numel(W)),' Okubo calculation for Kuril2007'])
